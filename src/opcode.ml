...
type kind = UNIMPL | P1 | B1 | P1P2 | P2 | Empty
...
let get_kind opcode =
  ...
  | NumberBitwiseXor | NumberCbrt | NumberCeil | NumberClz32 | NumberConstant
  | NumberCos | NumberCosh | NumberDivide | NumberEqual | NumberExp
  | NumberExpm1 | NumberFloor | NumberFround | NumberImul | NumberIsFinite
