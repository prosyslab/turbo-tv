...
let get_kind opcode =
  ...
  | NumberLog1p | NumberLog2 | NumberModulus | NumberPow | NumberRound
  | NumberSameValue | NumberShiftLeft | NumberShiftRight
  ...
  | NumberMultiply | ReferenceEqual | SpeculativeNumberAdd
