...
let get_kind opcode =
  ...
  | CheckedInt64Div | CheckedInt64Mod | CheckedInt64ToTaggedSigned
  ...
  | JSDeleteProperty | JSDivide | JSEqual | JSExponentiate
  | JSFindNonDefaultConstructorOrConstruct | JSForInEnumerate | JSForInNext
  | JSForInPrepare | JSFulfillPromise | JSGeneratorRestoreContext
